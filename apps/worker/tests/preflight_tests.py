...
class TestSepoliaPreflight(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_config.WALLET_ADDRESS = SecretStr("0x1111111111111111111111111111111111111111")
    ...
    def test_all_checks_pass(self, mock_config):
        ...
        mock_config.WALLET_ADDRESS = SecretStr("0x1111111111111111111111111111111111111111")
